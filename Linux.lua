...
function Linux:Notify(config)
    ...
    local Notification = Linux.Instance("Frame", {
        ...
        BorderColor3 = Color3.fromRGB(20, 20, 21),
        BorderSizePixel = 0,
...
function Linux.Create(config)
    ...
    local ConfirmationDialog = Linux.Instance("Frame", {
        Parent = LinuxUI,
    ...
    local DialogTitle = Linux.Instance("TextLabel", {
        Parent = ConfirmationDialog,
        BackgroundTransparency = 1,
    ...
    local DialogDescription = Linux.Instance("TextLabel", {
        Parent = ConfirmationDialog,
        BackgroundTransparency = 1,
        Size = UDim2.new(1, -30, 0, 40),
        Position = UDim2.new(0, 15, 0, 35),
        Font = Enum.Font.GothamSemibold,
        Text = "Are you sure you want to close the interface? This action cannot be undone.",
        TextColor3 = Color3.fromRGB(180, 180, 190),
        TextSize = 13,
        TextXAlignment = Enum.TextXAlignment.Left,
        TextWrapped = true,
    ...
    local CancelButton = Linux.Instance("TextButton", {
        Parent = ConfirmationDialog,
        BackgroundColor3 = Color3.fromRGB(0, 120, 255),
        BorderSizePixel = 0,
    ...
    local ConfirmButton = Linux.Instance("TextButton", {
        Parent = ConfirmationDialog,
        BackgroundColor3 = Color3.fromRGB(0, 120, 255),
        BorderSizePixel = 0,
        Size = UDim2.new(0, 100, 0, 32),
        Position = UDim2.new(1, -115, 1, -47),
        Font = Enum.Font.GothamSemibold,
        Text = "Confirm",
        TextColor3 = Color3.fromRGB(255, 255, 255),
        TextSize = 14,
    ...
    local Frame_inside_TopBar = Linux.Instance("Frame", {
        Parent = TopBar,
        BackgroundColor3 = Color3.fromRGB(18, 18, 20),
        BorderSizePixel = 0,
    ...
    local function ShowConfirmationDialog()
        ...
        ConfirmationDialog.BackgroundTransparency = 1
        
        local mainPos = Main.Position
        local mainSize = Main.Size
        ConfirmationDialog.Position = UDim2.new(
            mainPos.X.Scale, 
            mainPos.X.Offset + (mainSize.X.Offset / 2) - 140,
            mainPos.Y.Scale,
            mainPos.Y.Offset + (mainSize.Y.Offset / 2) - 70
        )
        ConfirmationDialog.Size = UDim2.new(0, 280, 0, 140)
        
        local tweenInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
        TweenService:Create(ConfirmationDialog, tweenInfo, {BackgroundTransparency = 0}):Play()
    end
    
    local function HideConfirmationDialog()
        local tweenInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.In)
        TweenService:Create(ConfirmationDialog, tweenInfo, {BackgroundTransparency = 1}):Play()
        task.wait(0.2)
    ...
    CancelButton.MouseEnter:Connect(function()
        TweenService:Create(CancelButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0, 140, 255)}):Play()
    end)
    
    CancelButton.MouseLeave:Connect(function()
        TweenService:Create(CancelButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0, 120, 255)}):Play()
    end)
    
    ConfirmButton.MouseEnter:Connect(function()
        TweenService:Create(ConfirmButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0, 140, 255)}):Play()
    end)
    
    ConfirmButton.MouseLeave:Connect(function()
        TweenService:Create(ConfirmButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(0, 120, 255)}):Play()
    end)
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Button(config)
            ...
            local originalColor = Color3.fromRGB(17, 17, 18)
            local clickColor = Color3.fromRGB(17, 17, 18)
            local tweenInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
